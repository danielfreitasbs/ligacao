...
class PromotorDAOtest {
    ...
    void testDAOPromotorJuridico() throws IOException, InterruptedException, ExecutionException {
        PromotorJuridico promotorJuridicoTeste = new PromotorJuridico("userTesteJ", "senhaTesteJ", "testeNomeResponsavel", 
                "325", "0001", "testeRazaoSocial", "31/12/2099", "img", "http", "categoriaTeste", "descricaoteste", 
        ...
        PromotorJuridico promotorJuridicoTesteSenhaAlterada = PromotorDAO.loginPromotorJuridico("userTesteJ", "senhaAlterada");
